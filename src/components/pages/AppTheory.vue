          ...
          section: {
            ...
            emailSendingProcess: {
              ...
              data: [
                ...
                'В конце концов, почтовый сервер – это компьютер, который помогает перемещать файлы по назначению. В этом случае, конечно, эти файлы являются сообщениями электронной почты. Их легко принять как должное, но разумно иметь базовые представления о том, как работают почтовые серверы.'
              ]
            }
          }
        }
